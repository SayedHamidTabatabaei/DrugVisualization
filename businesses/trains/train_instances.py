...
drug_train_test_file_train_id = 1563
drug_test_test_file_train_id = 1706
...
def get_instance(category: TrainModel) -> TrainBaseService:
    if category == TrainModel.JoinBeforeSoftmax:
        ...
        return GatEncAdvDnnTrainService(category, encoding_dim=128, gat_units=64, num_heads=4, dense_units=[1024, 512, 256], droprate=0.3, pooling_mode='mean',
        ...
        return FoldGatEncAdvDnnTrainService(category, encoding_dim=128, gat_units=64, num_heads=4, dense_units=[1024, 512, 256], droprate=0.3, pooling_mode='mean',
                                            batch_size=64, lr_rate=1e-4, adam_beta=[0.9, 0.999], alpha=0.1, schedule_number=2)
