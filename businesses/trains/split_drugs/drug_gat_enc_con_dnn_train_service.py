...
train_model = TrainModel.Drug_GAT_Enc_Con_DNN or TrainModel.Drug_GAT_Enc_Con_DNN_Test


class DrugGatEncConDnnTrainService(TrainBaseService):

    def __init__(self, category, encoding_dim, gat_units, num_heads, dense_units, droprate, pooling_mode='mean', compare_train_test: bool = True, file_train_id: int = None):
