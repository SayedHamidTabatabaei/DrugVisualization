...
from businesses.trains.models.gat_mha_rd_model import GatMhaRDTrainModel
...
train_model = TrainModel.Drug_GAT_MHA_RD_DNN or TrainModel.Drug_GAT_MHA_RD_DNN_Test


class DrugGatMhaRDDnnTrainService(TrainBaseService):
    ...
    def train(self, parameters: SplitDrugsTestWithTrainTrainingParameterModel) -> TrainingSummaryDTO:
        ...
        for x_train, x_test, y_train, y_test in super().manual_k_fold_train_test_data(parameters.drug_data, parameters.interaction_data,
            ...
            model = GatMhaRDTrainModel(parameters.train_id, categories, self.num_classes, parameters.interaction_data, training_params=training_params)
