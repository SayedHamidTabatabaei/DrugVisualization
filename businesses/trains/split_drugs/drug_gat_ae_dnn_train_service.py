from businesses.trains.models.gat_ae_model import GatAeTrainModel
...
train_model = TrainModel.Drug_GAT_AE_DNN or TrainModel.Drug_GAT_AE_DNN_Test


class DrugGatAeDnnTrainService(TrainBaseService):
