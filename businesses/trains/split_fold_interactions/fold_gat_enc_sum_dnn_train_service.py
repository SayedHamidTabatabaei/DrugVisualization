...
train_model = TrainModel.Fold_GAT_Enc_Sum_DNN


class FoldGatEncSumDnnTrainService(TrainBaseService):

    def __init__(self, category, encoding_dim, gat_units, num_heads, dense_units, droprate):
