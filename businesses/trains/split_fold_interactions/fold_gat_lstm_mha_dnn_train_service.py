...
from businesses.trains.models.gat_lstm_mha_model import GatLstmMhaTrainModel
...
train_model = TrainModel.Fold_GAT_Lstm_MHA


class FoldGatLstmMhaDnnTrainService(TrainBaseService):
    ...
    def train(self, parameters: SplitDrugsTestWithTrainTrainingParameterModel) -> TrainingSummaryDTO:
        ...
        for x_train, x_test, y_train, y_test in super().fold_on_interaction_deepface(parameters.drug_data, parameters.interaction_data,
            ...
            model = GatLstmMhaTrainModel(parameters.train_id, categories, self.num_classes, parameters.interaction_data, training_params=training_params)
