...
train_model = TrainModel.GAT_MHA_Reverse


class GatMhaReverseTrainService(TrainBaseService):
    ...
    def train(self, parameters: SplitInteractionSimilaritiesTrainingParameterModel) -> (TrainingSummaryDTO, object):
        ...
        model = GatMhaTrainModel(parameters.train_id, categories, self.num_classes, parameters.interaction_data, training_params=training_params, reverse=True)
