from businesses.trains.models.svm_model import SVMModel
...
class SvmTrainService(TrainBaseService):
    ...
    def train(self, parameters: SplitInteractionSimilaritiesTrainingParameterModel) -> TrainingSummaryDTO:
        ...
        model = SVMModel(parameters.train_id, self.num_classes, parameters.interaction_data, training_params=training_params)
