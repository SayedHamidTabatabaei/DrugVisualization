from businesses.trains.models.join_before_softmax_model import JoinBeforeSoftmaxModel
...
class JoinBeforeSoftmaxTrainService(TrainBaseService):
    ...
    def train(self, parameters: SplitInteractionSimilaritiesTrainingParameterModel) -> TrainingSummaryDTO:
        ...
        model = JoinBeforeSoftmaxModel(parameters.train_id, self.num_classes, parameters.interaction_data, training_params=training_params)
