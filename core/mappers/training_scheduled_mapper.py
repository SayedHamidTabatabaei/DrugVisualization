...
def map_training_schedule(query_results) -> TrainingScheduledDTO:
    id, name, description, train_model, training_conditions, schedule_date = query_results[0][0]
...
def map_training_schedules(query_results) -> list[TrainingScheduledDTO]:
    ...
    for result in query_results:
        id, name, description, train_model, training_conditions, schedule_date = result
