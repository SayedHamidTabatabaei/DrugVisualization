...
class TrainModel(Enum):
    ...
    Drug_CNN_DDI = (212, Scenarios.SplitDrugsTestWithTrain, 'NotFound', 'The Old Base Algorithm, use CNN.')
    ...
    Drug_CNN_DDI_Test = (312, Scenarios.SplitDrugsTestWithTest, 'NotFound', 'The Old Base Algorithm, use CNN.')
    ...
    Fold_CNN_DDI = (412, Scenarios.FoldInteractionSimilarities, 'NotFound', 'The Old Base Algorithm, use CNN.')
    ...
    CNN_DDI = (503, Scenarios.SplitInteractionSimilarities, 'NotFound', 'The Old Base Algorithm, use CNN.')
