...
class LossFunctions(Enum):
    categorical_crossentropy = (1, "categorical_crossentropy", "categorical cross entropy=",
                                [TrainModel.AE_Con_DNN, TrainModel.Con_AE_DNN, TrainModel.Contact_DNN, TrainModel.JoinBeforeSoftmax,
                                 TrainModel.SumSoftmaxOutputs, TrainModel.MHA, TrainModel.GAT_Enc_Con_DNN, TrainModel.GAT_MHA_DNN, TrainModel.GAT_AE_DNN,
                                 TrainModel.Drug_AE_Con_DNN, TrainModel.Drug_GAT_Enc_Con_DNN, TrainModel.Drug_GAT_Enc_Con_DNN_Test, TrainModel.Fold_GAT_Enc_Con_DNN])
